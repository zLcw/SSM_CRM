...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${requestScope.stageList}" var="stage">
			<%-- 如果stage是当前交易所处的阶段，则图标显示为map-marker，颜色为绿色 --%>
			...
			<%-- 如果stage是所处阶段的前面，则图标显示为ok-circle，颜色显示为绿色 --%>
			...
			<%-- 如果stage在当前交易所处的后面，则图标显示为record，颜色为灰色 --%>
			<c:if test="${stage.orderNo>requestScope.tran.orderNo}">
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${requestScope.tran.possible}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		...
		<div style="position: relative; top: 100px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable" class="table table-hover" style="width: 900px;">
					...
					<tbody id="hTbody">
						<c:forEach items="${requestScope.historyList}" var="ht">
							<tr>
								<td>${ht.stage}</td>
								<td>${ht.money}</td>
								<td>${ht.expectedDate}</td>
								<td>${ht.createBy}</td>
								<td>${ht.createTime}</td>
							</tr>
						</c:forEach>
