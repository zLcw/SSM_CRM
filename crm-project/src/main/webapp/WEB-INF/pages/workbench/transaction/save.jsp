...
<script type="text/javascript">
	$(function () {
		...
		$("#create-stage").change(function () {
			// 获取参数
			var stageValue = $("#create-stage option:checked").text();
			// 表单验证
			if (stageValue==""){
				// 清空可能性输入框
			...
			// 发送请求
			$.ajax({
				url: "workbench/transaction/getPossibleByStage.do",
				data: {
		...
		$("#saveCreateTranBtn").click(function () {
			...
			// 发送请求
			$.ajax({
				url: "workbench/traansaction/saveCreateTran.do",
				data: {
					owner : owner ,
					money : money ,
					name : name ,
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-type">
				  <option></option>
					<c:forEach items="${requestScope.tyList}" var="ty">
						<option value="${ty.id}">${ty.value}</option>
					</c:forEach>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" value="02bcce1bafe7404c9cd1f6a83bba530b" id="create-activityId">
				<input type="text" class="form-control" id="create-activityName" value="打螺丝">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="75aa335d1c7d4d2687f5263257221015" >
				<input type="text" class="form-control" id="create-contactsName" value="韩建军">
			</div>
		</div>
