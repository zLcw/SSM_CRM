...
<%
	 ...
	 * request.getScheme()：获取网路协议   				相当于 http
	 * request.getServerName() ：获取服务器的IP地址  		相当于 127.0.0.1
	 * request.getServerPort() ：获取服务器的端口号    	相当于 8080
	 * request.getContextPath() ： 获取应用程序的名字 	相当于 crm
	 */
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#logOutBtn").click(function () {
			// 发送请求
			window.location.href= "settings/qx/user/loginOut.do";
		});
